...
{
    private readonly ICertificatesService _certificatesService = ServiceProvider.certificatesService;
    ...
    public void Get_ShouldReturnDataSet_WhenFullNameExists()
    {
        ...
        {
            new Certificate { Course = new Course() { Title = "PHP для начинающих" }, IssueDate = new DateTime(2021, 1, 19), Grade = 70 },
            new Certificate { Course = new Course() { Title = "Введение в HTML и CSS" }, IssueDate = new DateTime(2021, 1, 12), Grade = 85 },
            new Certificate { Course = new Course() { Title = "JavaScript для начинающих" }, IssueDate = new DateTime(2021, 1, 5), Grade = 95 }
        };
